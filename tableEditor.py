...
class TableEditor(wid.QDialog):
    ...
    def setEditControls(self):
        #Set up control in QGridView for showing one record at time
        pass
        
        
    def setMappings(self):
        #Set mappings between controls and table fields
        pass

    def isValid(self):
        #Check data before write to table
...
def main():
    ...
    if not db.open():
        ...
        sys.exit(1)
    wrefrences = ReferencesEdit("ref_table")
    wrefrences.show()
    sys.exit(qapp.exec_())
